...
--
-- Host: localhost
-- Generation Time: May 23, 2025 at 10:23 AM
...
CREATE TABLE `kegiatan` (
  `id_kegiatan` int(22) NOT NULL,
  `nama_kegiatan` varchar(222) NOT NULL,
...
INSERT INTO `kegiatan` (`id_kegiatan`, `nama_kegiatan`, `tanggal_kegiatan`, `waktu_kegiatan`, `tempat_kegiatan`, `deskripsi_kegiatan`) VALUES
(1, 'sdgdsffd', '2025-05-05', '17:56:00', 'balai desa\r\n', 'aslkdfglksjdfgjhsdfgkajsdgkjfasdfhgsdf\r\njsdhfgjdsghf'),
(2, 'Rapat', '2025-05-20', '18:08:00', 'Rumah RT', 'rapat cok mbahas tai');
...
INSERT INTO `website` (`id`, `title`, `nama`, `deskripsi`) VALUES
(1, 'Ruvu Apps', 'Mars', 'Desa mars memliki nuansa yang unik nan cantik. </br> Cocok untuk tinggal lama ataupun sementara.');
...
--
ALTER TABLE `kegiatan`
  MODIFY `id_kegiatan` int(22) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
